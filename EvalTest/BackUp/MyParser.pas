  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if (i=0) or (i=expr.Count-1) or ('+-u*/^|~%&sincostgctgabsshchthcthexpasinacosatanlnlgsqrtpowlog'.Contains(expr[i - 1].name) or
...
begin
  ...
  begin
    if Check and (expr.Count>0) then
    begin
      Calculate(expr, x, y);
      if isNaN(y) then
        Result := False
